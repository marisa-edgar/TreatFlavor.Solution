...
namespace TreatFlavor.Migrations
{
    ...
    partial class FlavorTreatContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TreatFlavor.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("TreatFlavor.Models.Treat", b =>
                {
                    b.Property<int>("TreatId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TreatFlavor.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TreatFlavor.Models.FlavorTreat", b =>
                {
                    b.HasOne("TreatFlavor.Models.Flavor", "Flavor")
                        .WithMany("JoinEntities")
                        .HasForeignKey("FlavorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TreatFlavor.Models.Treat", "Treat")
                        .WithMany("JoinEntities")
